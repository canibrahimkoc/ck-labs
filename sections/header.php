...
wp_enqueue_script( 'mylisting-header' );
...
?>
<div class="lines"><span class="line line-1"></span><span class="line line-2"></span><span class="line line-3"></span></div>
	...
	<div class="header-container">
		<div class="header-top container-fluid">
				...
				<?php if ( is_user_logged_in() ): ?>
					...
					<?php echo str_replace(
						...
						wp_nav_menu( [
							...
							'items_wrap' => '<ul id="%1$s" class="%2$s main-nav no-list-style">%3$s</ul>'
						]
					) ) ?>
			...
			<div class="header-right">
				<span class="header-right-alert">Switch between color and language modes!</span>
				
				<div class="widget widget_netzen_core_switcher qodef-header-widget-area-one" data-area="header-widget-one">
					<div class="widget qodef-switcher">
						<div class="qodef-switch">
							<input type="checkbox" name="switch" class="qodef-switch-input" id="themeSwitch141">
							<label class="qodef-switch-label" for="themeSwitch141">
